      ...
      <Section title="Sign up" className="w-screen max-w-sm min-w-125">
        ...
        <div className="flex gap-3 px-3">
          <button
            ...
            type="button"
            disabled={loading || oauth !== null}
            onClick={() => startOAuth("google", "/accounts/google/login/")}
            className="flex-1 inline-flex items-center justify-center gap-2 bg-white text-[#3c4043] border border-[#747775] rounded h-10 px-4 font-medium text-sm hover:scale-105 cursor-pointer disabled:cursor-default disabled:opacity-60 disabled:hover:scale-100"
          >
          ...
          <button
            ...
            type="button"
            disabled={loading || oauth !== null}
            onClick={() => startOAuth("fortytwo", "/accounts/fortytwo/login/")}
            className="flex-1 inline-flex items-center justify-center gap-2 bg-white text-[#3c4043] border border-[#747775] rounded h-10 px-4 font-medium text-sm hover:scale-105 cursor-pointer disabled:cursor-default disabled:opacity-60 disabled:hover:scale-100"
          >
